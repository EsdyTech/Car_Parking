...
<form action="viewClients.php" method="post">
 ...
 <td><?php echo ("<button class=\"btn btn-success\" onclick=\"return confirm('Are you sure to Delete this User?')\"  name=\"submit_multi\" type=\"submit\" value=$id>Delete</button>") ?></td>
                                </tr>
                         <?php  } ?>
...
if (isset($_POST['submit_multi'])){
	...
	if(mysql_affected_rows()>0){
	 	...
	 	echo '<script type="application/javascript">alert("User Deleted Successfully!");</script>';
		echo '<script>window.location= "viewClients.php";</script>';
...
<p>Safe Parking, whenever you are in Here!</p>
</section>
</body>
</html>
